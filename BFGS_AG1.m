function [Y, X, iter, funcEval] = BFGS_AG1(func, x0, H0, h, maxIter, toler, display)
% Function BFGS_AG1 performs multivariate local optimization using the BFGS method 
